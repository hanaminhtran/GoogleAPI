...
{
    public class GooglePhrasebookSaveModel : PageModel
    {
        const string SessionName = "status";
        ...
        public GooglePhrasebookSaveModel(WebApplication1.Data.WebApplication1Context context)
        {
            _context = context;
        }
        ...
        [BindProperty]
        public GooglePhraseModel GooglePhraseModel { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            SavePhraseBook(GooglePhraseModel.txtFromText, GooglePhraseModel.txtToText, "en", "vi");

            //await _context.SaveChangesAsync();            
            var session = String.Format("\"{0}\"", GooglePhraseModel.txtFromText);
            HttpContext.Session.SetString(SessionName, session);
            ViewData["Status"] = session;            
            GooglePhraseModel.txtToText = "";
            GooglePhraseModel.txtFromText = "";
            ModelState.Clear();
            return Page();            
        }
    }
